...
stopuser = {}
token ='6777280816:AAFBbxBwTYx_kWvi4ytwjzfOrmLAt2Ikoqw'
	...
	def my_function():
	  ...
	  "timer": "none",
		...
		if BL == '𝗙𝗥𝗘𝗘':	
			...
			contact_button = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="https://t.me/sad3pubg3")
...
𝒀𝑶𝑼𝑹 𝑷𝑳𝑨𝑵 𝑵𝑶𝑾 {BL}</b>
	''',reply_markup=keyboard)
			return
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="✨ 𝗝𝗢𝗜𝗡 ✨", url="https://t.me/sad3pubg3")
		keyboard.add(contact_button)
...
𝘽𝙤𝙩 𝘽𝙮 @sad_b9''', reply_markup=mes)
